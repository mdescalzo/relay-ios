...
public class AudioActivity: NSObject {
    ...
    override public var description: String {
        return "<AudioActivityDescription: \"\(audioDescription)\">"
    }
...
public class OWSAudioSession: NSObject {
    ...
    public func startAmbientAudioActivity(_ audioActivity: AudioActivity) {
        ...
        do {
            ...
            DDLogError("\(logTag) in \(#function) failed with error: \(error)")
        }
    }
    ...
    // MARK: - Logging
    var logTag: String {
        return OWSAudioSession.self.description()
    }
}
